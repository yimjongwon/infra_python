...
================================================================
26.05.06
사설네트워크끼리 연결 tunneling vpn:난이도높음 -> tailscale
https://oli999.github.io/simulation/
...
26.05.15
id, name, arn ...
arn: aws에서 만들어진 수십 억개의 resource들을 유일하게 식별할 수 있는 식별값(주소)
-> nosql db에서 가져오는 구조다!


alb
alb 리스너->alb->target group->ec2
client->route 53->alb(acm)->asg->ec2
